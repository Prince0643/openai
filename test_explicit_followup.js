// Test the updated response format with explicit follow-up
...
// Generate the updated response format
function generateUpdatedResponse(scheduleData) {
...
const updatedResponse = generateUpdatedResponse(mockSchedule);

console.log("=== Updated Response Format ===");
console.log(updatedResponse);

console.log("\n=== Verification ===");
console.log("Includes explicit follow-up:", updatedResponse.includes("Follow-up: Let me know which day you'd like to see next."));
console.log("Line count:", updatedResponse.split('\n').length);
...
console.log("");
console.log("Follow-up: Let me know which day you'd like to see next.");