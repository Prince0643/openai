  ...
  try {
    ...
    try {
      ...
      if (jsonResponse.response) {
        ...
        // Check if response follows format rules (4-7 lines, plain text)
        if (lineCount >= 4 && lineCount <= 7) {
          console.log('✅ Line count within specification (4-7 lines)');
        } else {
          console.log('❌ Line count outside specification');
        }
      } else {
